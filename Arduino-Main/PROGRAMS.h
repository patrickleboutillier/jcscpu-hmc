...
// Adds 20 and 22 together and prints the result to IO device #1.
...
// Performs a 5x5 multiplication and prints the result to IO device #1.
...
// Maurice Wilkes' famous Squares program for the EDSAC.
// Prints a table of the squares and differences for integers 1-15.
